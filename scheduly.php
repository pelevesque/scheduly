...
class Scheduly {
    ...
    {
        $this->setDefaultTimezone($timezone_identifier);
    }
     ...
     * @return  void
     */
    public function calculateWeek($year = NULL, $week = NULL, $timezone_identifier = NULL)
    {
        // set the timezone
        $this->setDefaultTimezone($timezone_identifier);

        // set the year and week
        $this->setYearAndWeek($year, $week);

        // set the bordering years and weeks
        $this->setBorderingYearsAndWeeks();
     ...
     * @return  void
     */
    protected function setDefaultTimezone($timezone_identifier)
    {
     ...
     * @return  void
     */
    protected function setYearAndWeek($year, $week)
    {
     ...
     * @return  void
     */
    protected function setBorderingYearsAndWeeks()
    {
        if ($this->week == 1) {
    ...
    protected function setTimestamps()
    {
        ...
        $min = $this->minUTCOffset(23, $this->dates[0]);
        ...
        for ($i=0; $i<7; $i++) {
            ...
            for ($j=0; $j<24; $j++) {
                ...
                $min = $this->minUTCOffset($j, $this->dates[$i]);
        ...
        $min = $this->minUTCOffset(0, $this->dates[7]);
     ...
     */
    protected function minUTCOffset($hour, $timestamp)
    {
